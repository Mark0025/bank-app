...
import type { FeedbackInternalOptions, FeedbackWidget, OptionalFeedbackConfiguration } from '@sentry-internal/feedback/types/types';
import { createShadowHost } from '@sentry-internal/feedback/types/widget/createShadowHost';
