  ...
  return (
   <section className= "auth-form">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
          {type === 'sign-up' && (
            ...
            <div className="flex gap-4">
              <CustomInput control={form.control} name="state" label="state" placeholder="OK,TX,CA" />
            
              <CustomInput control={form.control} name="postalCode" label="Postal Code" placeholder="73099" />
            </div>
    ...
    <footer className="flex justify-center gap-1">
      ...
      <Link href={type === "sign-in" ? "/sign-up" : "/sign-in"} className="text-16 font-medium text-blue-500">
